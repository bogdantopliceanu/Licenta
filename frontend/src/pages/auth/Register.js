...
const Register = () => {
    ...
    const handleInputChange = (e) => {   //e -> event
        ...
        setformData({ ...formData, [name]: value}) //...formData preia si informatiile scrise dinainte in form
    }

    const register = async (e) => {
        e.preventDefault()   //formul nu da reaload la pagina. care e comportamentul default
