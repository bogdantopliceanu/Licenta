      ...
      <div className="destination-list">
        ...
        {!isLoading && destinations.length === 0 ? (
          ...
          currentItems.map((destination, index) => {
            const { _id, name, things_to_do, description, image } = destination;
            ...
            return (
              ...
              >
                ...
                <div className="card-content">
                  <h3 className="card-title">{shortenText(name, 16, isCardExpanded)}</h3>
          ...
          currentItems.map((destination, index) => {
            ...
            return (
              ...
              >
                ...
                />
                <div className="card-content">
                  <h3 className="card-title">{shortenText(name, 30, isCardExpanded)}</h3>
                  <p><b>Recommended activities:</b></p>
                  <p className="card-things-to-do">
                    <div
                      dangerouslySetInnerHTML={{
